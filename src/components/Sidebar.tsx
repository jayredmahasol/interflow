    ...
    <div className="flex h-screen w-64 flex-col border-r border-dark-serpent/10 bg-paper">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="space-y-1 px-2">
          <Link to="/" className="group flex items-center rounded-md bg-dark-serpent/5 px-3 py-2 text-sm font-medium text-dark-serpent">
            <LayoutDashboard className="mr-3 h-5 w-5 flex-shrink-0 text-dark-serpent/70" />
            Dashboard
          </Link>
          <Link to="/applicants" className="group flex items-center rounded-md px-3 py-2 text-sm font-medium text-dark-serpent/70 hover:bg-dark-serpent/5 hover:text-dark-serpent">
          ...
          <Link to="/settings" className="group flex items-center rounded-md px-3 py-2 text-sm font-medium text-dark-serpent/70 hover:bg-dark-serpent/5 hover:text-dark-serpent">
            <Settings className="mr-3 h-5 w-5 flex-shrink-0 text-dark-serpent/50 group-hover:text-dark-serpent/70" />
            Settings
          </Link>
          <Link to="/notifications" className="group flex items-center rounded-md px-3 py-2 text-sm font-medium text-dark-serpent/70 hover:bg-dark-serpent/5 hover:text-dark-serpent">
            <Mail className="mr-3 h-5 w-5 flex-shrink-0 text-dark-serpent/50 group-hover:text-dark-serpent/70" />
            Notifications
          </Link>
        </nav>
